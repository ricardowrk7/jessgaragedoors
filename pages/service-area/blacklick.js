...
const Blacklick = () => {
    const city = 'Blacklick';
    const data = {
        city: "Blacklick",
        paragraphOne: `Get your garage door repaired in ${city}, Ohio! Jess Overhead Garage Doors is a trusted, family-owned garage door repair business that has provided superior repair services for Blacklick, Ohio and the surrounding areas for many decades. Whether you want to upgrade your home and install an automatic garage door or just need to repair a broken spring or track, our team will provide you with the services you need for your home or business. `,
        ...
        paragraphFour: <><a href='schedule-service'>Contact Us Now</a> to schedule your garage door service in Blacklick, Ohio.</>,
