...
const Newark = () => {
    ...
    const data = {
        ...
        zip: '43055, 43093',
        paragraphEight: `Jess Overhead Garage Doors has been providing Newark, OH with the best garage door repair services for over 40 years! Newark is a city in and the county seat of Licking County, Ohio, United States, 33 miles east of Columbus, at the junction of the forks of the Licking River. The population was 47,573 at the 2010 census, which makes it the 20th largest city in Ohio. Call us now and get the best garage door repair services in Newark, Ohio!`
       }
       ...
       const locations = [
        {
            id: 7,
            name: city,
            latitude: "40.05731201171875",
            longitude: "-82.4039535522461",
            circle: {
              radius: 3000,
              options: {
                strokeColor: "#FF0000",
