...
const NewAlbany = () => {
    ...
    const data = {
        ...
        zip: '43031, 43054, 43062',
        paragraphEight: `Jess Overhead Garage Doors has been providing ${city}, OH with the best garage door repair services for over 40 years! ${city} is a city in the U.S. state of Ohio, located 15 miles northeast of the state capital of Columbus. Most of the city is located in Franklin County and a small portion extends into adjacent Licking County. New Albany had an estimated population of 10,933 in 2019, up from 7,724 at the 2010 census. Call us now and get the best garage door repair services in ${city}, Ohio!`
       }
